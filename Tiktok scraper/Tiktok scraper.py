...
def get_video_stat(username, start_date, end_date):
    ...
    with TikTokAPI() as api:
        ...
        # Initialize progress bar without total length
        pbar = tqdm(desc="Processing videos", dynamic_ncols=True, bar_format='{l_bar}{bar} [{elapsed}<{remaining}, {rate_fmt}{postfix}]')
