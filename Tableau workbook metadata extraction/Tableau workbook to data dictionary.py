...
# ตัวอย่างการใช้งาน:
output_file = export_tableau_data_dictionary(r'D:\your folder\your tableau workbook.twb') # ระบุที่อยู่ไฟล์ของ Tableau workbook ที่ต้องการสร้าง data dictionary Downloads